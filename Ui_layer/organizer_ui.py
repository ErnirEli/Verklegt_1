...
class OrganizerUI:
    ...
    def create_player(self):
        ...
        state = self.player_logic.create_player(name, age, address, number, email, link, handle)
        if state == True:
    ...
    def edit_player_info(self):
        handle = input("Please provide the handle of the player you want to modify: ").strip()
        if handle == "":
        ...
        #New phone
        while True:
            raw_phone = input("New phone (digits only, empty to keep current): ").strip()
            if raw_phone == "":
                new_phone = None
                break
            ...
            try:
                self.validate_player.validate_number(new_phone)
                break
            except InvalidNumberException:
                print("Number is invalid, try again.")
        ...
        while True:
            ...
            try:
                self.validate_player.validate_link(new_link)
                break
            except InvalidLinkException:
        ...
        if state:
            ...
            print("Could not modify player (player not found).")
